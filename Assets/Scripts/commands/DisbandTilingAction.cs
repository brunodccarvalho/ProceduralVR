...
[System.Serializable]
public struct DisbandTilingAction : UndoableAction {
    public ProceduralTiling procedural;
    public Transform parent;
    public List<ParentRecord> before, after;

    public DisbandTilingAction(ProceduralTiling procedural) {
    ...
    public DisbandTilingAction(Transform transform)
        : this(transform.GetComponent<ProceduralTiling>()) { }
    ...
    public override string ToString() {
        ...
        return string.Format("DisbandTiling [{0}] [{1}]", procedural.name, nameList);
    }
}
