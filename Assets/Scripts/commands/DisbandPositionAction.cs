...
[System.Serializable]
public struct DisbandPositionAction : UndoableAction {
    public ProceduralPosition procedural;
    public Transform parent;
    public List<ParentRecord> before, after;

    public DisbandPositionAction(ProceduralPosition procedural) {
    ...
    public DisbandPositionAction(Transform transform)
        : this(transform.GetComponent<ProceduralPosition>()) { }
